...
class IndicatorAgentState(TypedDict):
    ...
    adx: Annotated[List[float], "Average Directional Index values"]
    ...
    # Volume Agent
    volume_report: Annotated[str, "Final volume analysis summary, describing accumulation/distribution, spikes, and price-volume divergence"]

    # Final analysis and messaging context
    analysis_results: Annotated[str, "Computed result of the analysis or decision"]
    messages: Annotated[List[BaseMessage], add_messages]  # [FIX] Use add_messages to handle concurrent updates
