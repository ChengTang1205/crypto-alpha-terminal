...
class TechnicalTools:
    ...
    def compute_adx(
        ...
        period: Annotated[int, "Lookback period for ADX calculation (default is 14)"] = 14
    ) -> dict:
        """
        ...
        Args:
            kline_data: Dictionary with 'High', 'Low', and 'Close' keys
            period: Lookback period for ADX calculation (default 14)

        Returns:
            dict: Dictionary with key 'adx' mapping to the list of ADX values
        """
        df = pd.DataFrame(kline_data)
